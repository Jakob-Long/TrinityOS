...
global keyboard_handler2
global keyboard_handler3
global keyboard_handler_login
global keyboard_handler_christmas
global keyboard_handler_window
global ioport_in
global ioport_out
global enable_interrupts

extern bootScreen			; Defined in kernel.c
extern handle_keyboard_interrupt
extern handle_keyboard_interrupt2
extern handle_keyboard_interrupt3
extern handle_keyboard_interrupt_login
extern handle_keyboard_interrupt_christmas
extern handle_keyboard_interrupt_window
...
keyboard_handler_window:
	pushad
	cld
	call handle_keyboard_interrupt_window
	popad
	iretd

keyboard_handler_christmas:
	pushad
	cld
	call handle_keyboard_interrupt_christmas
	popad
	iretd

keyboard_handler_login:
	pushad
	cld
	call handle_keyboard_interrupt_login
	popad
	iretd
...
keyboard_handler3:
	pushad
	cld
	call handle_keyboard_interrupt3
	popad
	iretd
...
keyboard_handler2:
	pushad
	cld
	call handle_keyboard_interrupt2
	popad
	iretd
